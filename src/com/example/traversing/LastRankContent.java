...
public class LastRankContent extends Activity{
	private String URL_PATH = "http://1.traversingoceans.sinaapp.com/index.php/api/lastrank/content";
	...
	result = intent.getStringExtra(LastRank.EXTRA_MESSAGE);
	 ...
	 public boolean onCreateOptionsMenu(Menu menu) {
	    ...
	    public boolean onOptionsItemSelected(MenuItem item) {
	        ...
	        // as you specify a parent activity in AndroidManifest.xml.
	         ...
	         case 1:  
	        	 Intent homepage = new Intent(LastRankContent.this,
							Homepage.class);
	        	 LastRankContent.this.startActivity(homepage); 
	             break;  
	         case 2:  
	        	 Intent aboutus = new Intent(LastRankContent.this,
							AboutUs.class);
	        	 LastRankContent.this.startActivity(aboutus); 
	             break;  
	         case 3:  
	        	 LastRankContent.this.exitDialog(); 
	             break;
	         }  
	...
	public void exitDialog() {
		Dialog dialog = new AlertDialog.Builder(LastRankContent.this)
